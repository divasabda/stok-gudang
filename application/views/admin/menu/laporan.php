                        ...
                        <div class="card-body">
                            <div class="row">
                              ...
                              <div class="small-box bg-gray">
                                ...
                                <a href="<?php echo base_url('admin/laporan-bahan')?>" class="small-box-footer" name="btn" target="_blank">Print</a>
                              </div>
                            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" action="<?php echo base_url('admin/laporan-periode-masuk')?>" method="post" accept-charset="utf-8" target="_blank">
                  <table class="table">
                    <tr>
                        <td>
            ...
            <div class="modal-footer">
                <a href="<?php echo base_url('admin/laporan-bahan-masuk')?>" id="submit" class="btn btn-success success" target="_blank">Cetak Semua Data</a>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="confirm-bahan-keluar" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" action="<?php echo base_url('admin/laporan-periode-keluar')?>" method="post" accept-charset="utf-8" target="_blank">
                  <table class="table">
                    <tr>
                        <td>
                          <div class="form-group">
            ...
            <div class="modal-footer">
                <a href="<?php echo base_url('admin/laporan-bahan-keluar')?>" id="submit" class="btn btn-success success" target="_blank">Cetak Semua Data</a>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="confirm-mutasi" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" action="<?php echo base_url('admin/laporan-periode-mutasi')?>" method="post" accept-charset="utf-8" target="_blank">
                  <table class="table">
                    <tr>
                        <td>
                          <div class="form-group">
            ...
            <div class="modal-footer">
                <a href="<?php echo base_url('admin/laporan-mutasi')?>" id="submit" class="btn btn-success success" target="_blank">Cetak Semua Data</a>
            </div>
        </div>
    </div>
</div>
