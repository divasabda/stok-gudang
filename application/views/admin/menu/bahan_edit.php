        ...
        <!-- Small boxes (Stat box) -->
          ...
          <div class="col-md-3">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="<?php echo base_url('admin/bahan/update-bahan')?>" method="post">
                <div class="card-body">
                  <div class="form-group">
                    <label>Id Bahan</label>
                    <input type="number" class="form-control" placeholder="Id Bahan" name="id-bahan" readonly="readonly" value="<?php echo $id_bahan?>">
                  </div>
                  <div class="form-group">
                    <label>Nama Bahan</label>
                    <input type="text" class="form-control" placeholder="Masukkan Nama Bahan" name="nama-bahan" value="<?php echo $nama_bahan?>">
                    <small class="form text text-danger"><?php echo form_error('nama-bahan');?></small>
                  </div>
                  <div class="form-group">
                    <label>Stock Bahan</label>
                    <input type="number" class="form-control"  placeholder="Masukkan Stock Bahan" name="stok-bahan" value="<?php echo $stok_bahan?>">
                    <small class="form text text-danger"><?php echo form_error('stok-bahan');?></small>
                  </div>
                  <div class="form-group">
                    <label>Satuan</label>
                    <input type="text" class="form-control" placeholder="Masukkan Satuan" name="satuan-bahan" value="<?php echo $satuan_bahan?>">
